...
WebUI.click(findTestObject('Object Repository/label_Facility'))

WebUI.click(findTestObject('Object Repository/form_Facility                              _20adf0'))

WebUI.click(findTestObject('Object Repository/label_Apply for hospital readmission'))

WebUI.click(findTestObject('Object Repository/label_Healthcare Program'))

WebUI.click(findTestObject('Object Repository/label_Medicare'))

WebUI.click(findTestObject('Object Repository/label_Medicaid'))

WebUI.click(findTestObject('Object Repository/label_None'))

WebUI.click(findTestObject('Object Repository/label_Visit Date (Required)'))

WebUI.click(findTestObject('Object Repository/input_Visit Date (Required)_visit_date'))

WebUI.click(findTestObject('Object Repository/div_Comment'))

WebUI.click(findTestObject('Object Repository/label_Comment'))

WebUI.click(findTestObject('Object Repository/form_Facility                              _20adf0'))

WebUI.click(findTestObject('Object Repository/button_Book Appointment'))

WebUI.click(findTestObject('Object Repository/div_Visit Date (Required)'))
